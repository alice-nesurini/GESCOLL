		...
		<div style="margin-left: 5%; margin-top: 5%;">
			<?php
				...
				while($row=mysqli_fetch_array($result)){
					...
					echo("Cod: <input type='text' class='form-control' name='cod' value='".$row['Cod']."' style='width:50%;'></br>");
					echo("Color: <input type='text' class='form-control' name='color' value='".$row['Color']."' style='width:50%;'></br>");
					echo("Price: <input type='text' class='form-control' name='price' value='".$row['Price']."' style='width:50%;'></br>");
					echo("Shipping: <input type='text' class='form-control' name='shipping' value='".$row['Shipping']."' style='width:50%;'></br>");
